d = {
    ...
    'WJets'               : ['WJets_ht200to400','WJets_ht400to600','WJets_ht600to800',
    ...
    'ZJets'               : ['ZJets_ht%sto%s'%(str(x[0]),str(x[1])) for x in 
                                [(200,400),(400,600),(600,800),(800,1200),(1200,2500),(2500,'inf')]],
    'ZJets_nlo'           : ['ZJets_pt%sto%s'%(str(x[0]),str(x[1])) for x in 
                             [(50,100),(100,250),(250,400),(400,650),(650,'inf')] ],
    'ZtoNuNu'             : ['ZtoNuNu_ht200to400','ZtoNuNu_ht400to600',
