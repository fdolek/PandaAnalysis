...
#submission number
export SUBMIT_NAME="80X_v1_SingleMuon_May27"
#scratch space
...
export PANDA_CFG="http://sundleeb.web.cern.ch/sundleeb/panda_config/SingleMuon_20180525.cfg"

#skim
export SUBMIT_TMPL="skim_lepmonotop_tmpl.py"
#panda's 
