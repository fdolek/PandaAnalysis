...
presel = 'nFatjet==1 && fj1Pt>200 && nTau==0 && Sum$(jetPt>30 && jetIso)<2 && fj1MSD>25'

cuts = {
 'signal' : tAND(metFilter,tAND(presel,'nLooseLep==0 && nLooseElectron==0 && nLoosePhoton==0 && pfmet>250 && dphipfmet>0.4')), 
 'mn'      : tAND(metFilter,tAND(presel,'nLoosePhoton==0 && nTau==0 && nLooseLep==1 && nTightMuon==1 && abs(muonPdgId[0])==13 && pfUWmag>250 && dphipfUW>0.4 && mT<160')),
 #'mn'      : tAND(metFilter,tAND(presel,'nLoosePhoton==0 && nTau==0 && nLooseLep==1 && nTightMuon==1 && abs(muonPdgId[0])==13 && pfUWmag>250 && dphipfUW>0.4')),
 'en'      : tAND(metFilter,tAND(presel,'nLoosePhoton==0 && nTau==0 && nLooseLep==1 && nTightElectron==1 && abs(electronPdgId[0])==11 && pfmet>50 && pfUWmag>250 && dphipfUW>0.4 && mT<160')),
 'zmm'    : tAND(metFilter,tAND(presel,'pfUZmag>250 && dphipfUZ>0.4 && nLooseElectron==0 && nLoosePhoton==0 && nTau==0 && nLooseMuon==2 && nTightLep>0 && 60<diLepMass && diLepMass<120')),
 'zee'    : tAND(metFilter,tAND(presel,'pfUZmag>250 && dphipfUZ>0.4 && nLooseMuon==0 && nLoosePhoton==0 && nTau==0 && nLooseElectron==2 && nTightLep>0 && 60<diLepMass && diLepMass<120')),
}
...
for r in ['signal','wmn','tmn','wen','ten','zmm','zee']:
	#cuts[r] = tAND(cuts[r],'fj1MinCSV>0.5426')
	cuts[r+'_fail'] = tAND(cuts[r],'fj1MinCSV<=0.5426')
