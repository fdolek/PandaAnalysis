...
#echo zmm wmn wen tmn ten zee signal | xargs -n 1 -P 8 python makeFittingForest.py --ddt True --region
echo zmm_fail wmn_fail wen_fail tmn_fail ten_fail zee_fail signal_fail | xargs -n 1 -P 8 python makeFittingForest.py --ddt True --region 