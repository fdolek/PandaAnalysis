...
cuts['wen']      = tAND(nLep1,'Sum$(jetCSV>0.8 && abs(jetEta)<2.5)==0')
cuts['wmn']      = tAND(nLep1,'Sum$(jetCSV>0.8 && abs(jetEta)<2.5)==0')
cuts['ttbar1e']  = tAND(nLep1,'Sum$(jetCSV>0.8 && abs(jetEta)<2.5)==2')
cuts['ttbar1m']  = tAND(nLep1,'Sum$(jetCSV>0.8 && abs(jetEta)<2.5)==2')
