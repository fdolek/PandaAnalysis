...
{
  if ( (preselBits&kMET) || (preselBits&kSingleEle) || (preselBits&kSingleMu) || (preselBits&kDiEle) || (preselBits&kDiMu) || (preselBits&kPho) || (preselBits&kOppositeSign) || (preselBits&kLepMonoTop) ) 
    {
